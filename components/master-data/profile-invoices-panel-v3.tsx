/**
 * Profile Invoices Panel V3 (Template A - Complex Detail)
 *
 * V3 redesign with:
...
interface ProfileInvoicesPanelV3Props {
  config: PanelConfig;
  onClose: () => void;
  profileId: number;
}
...
export function ProfileInvoicesPanelV3({
  config,
  onClose,
  profileId,
}: ProfileInvoicesPanelV3Props) {
      ...
      <div className="flex h-full">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex-1 overflow-auto p-6">
            <PanelSection title="Pending Invoices">
...
export default ProfileInvoicesPanelV3;
