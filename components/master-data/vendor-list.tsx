  ...
  return (
    <div className="overflow-x-auto rounded-lg border">
                ...
                <div className="flex items-center justify-end gap-2">
                  {vendor.is_active ? (
                    <>
                      ...
                      <button
                        onClick={() => handleArchive(vendor.id, vendor.name)}
      ...
      <ConfirmationDialog
        ...
        description="Are you sure you want to archive this vendor? It will be hidden from active lists but can be restored later."
        variant="warning"
      ...
      >
        {archiveDialogData && (
          <div className="space-y-2">
            <ConfirmationContentRow label="Vendor" value={archiveDialogData.name} />
          </div>
        )}
      </ConfirmationDialog>
    </div>
