 ...
 * Payment amounts over time line chart
...
import { PaymentTrendItem } from '@/types/dashboard';
...
export const PaymentTrendsChart = React.memo(function PaymentTrendsChart({
  data,
  isLoading = false,
}: PaymentTrendsChartProps) {
  // Custom tooltip
  const CustomTooltip = ({ active, payload }: { active?: boolean; payload?: Array<{ payload: PaymentTrendItem }> }) => {
