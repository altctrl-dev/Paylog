...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-200 focus:outline-none focus:ring-0 focus-visible:border-primary disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
